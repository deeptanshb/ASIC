...
# Generated on: Tue Sep 02 17:44:27 IST 2025 (Tue Sep 02 12:14:27 UTC 2025)
...
set logfile fv/seq_det_0010/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/seq_det_0010 -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/student/Desktop/22BEC1204_ASIC_DESIGN/work/seq_det_0010.v
elaborate_design -golden -root {seq_det_0010} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/seq_det_0010/fv_map.v.gz
elaborate_design -revised -root {seq_det_0010}
...
#add_name_alias fv/seq_det_0010/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.seq_det_0010.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.seq_det_0010.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.seq_det_0010.rtl.fv_map.rpt
