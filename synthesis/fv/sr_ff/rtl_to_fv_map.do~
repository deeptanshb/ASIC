...
# Generated on: Mon Aug 11 12:39:24 IST 2025 (Mon Aug 11 07:09:24 UTC 2025)
...
set logfile fv/sr_ff/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/sr_ff -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/student/Desktop/22BEC1204_ASIC_DESIGN/work/sr_ff.v
elaborate_design -golden -root {sr_ff} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/sr_ff/fv_map.v.gz
elaborate_design -revised -root {sr_ff}
...
#add_name_alias fv/sr_ff/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.sr_ff.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.sr_ff.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.sr_ff.rtl.fv_map.rpt
