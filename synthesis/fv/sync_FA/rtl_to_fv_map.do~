...
# Generated on: Mon Aug 11 12:29:27 IST 2025 (Mon Aug 11 06:59:27 UTC 2025)
...
set logfile fv/sync_FA/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/sync_FA -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/student/Desktop/22BEC1204_ASIC_DESIGN/work/sync_FA.v
elaborate_design -golden -root {sync_FA} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/sync_FA/fv_map.v.gz
elaborate_design -revised -root {sync_FA}
...
#add_name_alias fv/sync_FA/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.sync_FA.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.sync_FA.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.sync_FA.rtl.fv_map.rpt
