...
# Generated on: Fri Sep 05 16:38:22 IST 2025 (Fri Sep 05 11:08:22 UTC 2025)
...
set logfile fv/simple_processor/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/simple_processor -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/student/Desktop/22BEC1204_ASIC_DESIGN/work/simple_processor.v
elaborate_design -golden -root {simple_processor} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/simple_processor/fv_map.v.gz
elaborate_design -revised -root {simple_processor}
...
#add_name_alias fv/simple_processor/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.simple_processor.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.simple_processor.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.simple_processor.rtl.fv_map.rpt
